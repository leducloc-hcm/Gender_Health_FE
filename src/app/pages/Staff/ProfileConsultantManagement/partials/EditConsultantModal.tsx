...
const EditConsultantModal = memo(
  ({ isOpen, onOpenChange, selectedConsultant, setSelectedConsultant, onSave, onCancel }: EditConsultantModalProps) => {
    ...
    const handleInputChange = <K extends keyof ProfileConsultantResult>(
      ...
      setSelectedConsultant((prev: ProfileConsultantResult | null) => (prev ? { ...prev, [field]: value } : prev))
    }
            ...
            <div className='space-y-4'>
                ...
                <div key={id} className='space-y-2'>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      handleInputChange(id as keyof ProfileConsultantResult, processedValue)
                    }}
                    className='w-full'
                  />
                </div>
              ...
              <div className='space-y-2'>
                ...
                <SpecialtySelector
                  ...
                  onSelectionChange={(specialtyIds) => {
                    handleInputChange('specialtyIds', specialtyIds)
                  }}
                />
              </div>
